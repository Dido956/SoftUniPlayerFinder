...
public class Constants {
    public final static String TOWNS_FILEPATH = "src/main/resources/files/json/towns.json";
    public final static String TEAMS_FILEPATH = "src/main/resources/files/json/teams.json";
